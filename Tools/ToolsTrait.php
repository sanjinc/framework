...
trait ToolsTrait
{
	 ...
	 *
	 * @param string $url			Url address to which you want to redirect. If the address doesn't start with http(s), the current host will be set as root.
	 * @param array|null|string $params	Array containing request params that will be appended to the GET request.
	 */
	public function redirect($url, $params)
	{
		new \WF\Tools\Redirect\Redirect($url, $params);
	}
	...
	{
		return \WF\Tools\AutoLoader\AutoLoader::getInstance()->registerAutoloader($functionName, $prepend);
	}
}