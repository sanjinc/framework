...
trait Environment
{
    ...
    public function get($name, &$default = false) {
        return \WF\Architecture\Environment\Request::getInstance()->getRequestParameter($name, 'get', $default);
    }
    ...
    public function post($name, &$default = false) {
        return \WF\Architecture\Environment\Request::getInstance()->getRequestParameter($name, 'post', $default);
    }
     ...
     *
     * @return string|\WF\StdLib\StdObject\UrlObject\UrlObject
     */
    public function getCurrentUrl($asUrlStandardObject = false) {
        return \WF\Architecture\Environment\Request::getInstance()->getCurrentUrl($asUrlStandardObject);
    }
    ...
    public function isConnectionSecured() {
        return \WF\Architecture\Environment\Request::getInstance()->isConnectionSecured();
    }
    ...
    public function getVisitorsIp() {
        return \WF\Architecture\Environment\Request::getInstance()->getVisitorsIp();
    }
    ...
    public function getCurrentDomain() {
        return \WF\Architecture\Environment\Request::getInstance()->getCurrentDomain();
    }
    ...
    public function getPhpVersion() {
        return \WF\Architecture\Environment\Php::getInstance()->getVersion();
    }
    ...
    public function getOsName() {
        return \WF\Architecture\Environment\Os::getInstance()->getOsName();
    }
    ...
    public function getDirectorySeparator() {
        return \WF\Architecture\Environment\Os::getInstance()->getDirectorySeparator();
    }
    ...
    public function getAbsPath() {
        return \WF\Architecture\Environment\Path::getInstance()->absPath();
    }
}