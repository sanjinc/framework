...
class Client
{
	...
	public function __construct($client_id, $client_secret, $client_auth = self::AUTH_TYPE_URI,
		...
		if(!extension_loaded('curl')) {
			throw new Exception('The PHP cURL extension must be installed to use this library.', Exception::CURL_NOT_FOUND);
		}
	 ...
	 * @return array
	 */
	private function executeRequest($url, $parameters = array(), $http_method = self::HTTP_METHOD_GET,
